...
export default {
  ...
  aboutPage: {
    ...
    welcome:
      "Selamat datang di One AI Assistant! Didirikan oleh Dadan Abdillah (Founder) dan Saeful Rohman (Fullstack Developer), kami merevolusi cara bisnis men-deploy chatbot AI melalui platform berbasis proyek yang inovatif.",
    founded:
  ...
  contactPage: {
    ...
    subjectLabel: "Subjek",
    subjectPlaceholder: "Pertanyaan tentang harga",
    messageLabel: "Pesan",
    messagePlaceholder: "Pesan Anda...",
    sendMessageButton: "Kirim Pesan",
    contactInfoCardTitle: "Informasi Kontak",
    emailInfo: "Email",
    phoneInfo: "Telepon",
  ...
  forgotPasswordPage: {
    ...
    description: "Masukkan email Anda untuk mengatur ulang kata sandi Anda.",
    emailLabel: "Alamat Email",
    emailPlaceholder: "anda@example.com",
    sendResetLinkButton: "Kirim Tautan Reset",
    ...
    teamMembers: [
      {
        ...
        bio: "Mahasiswa Teknik Informatika Universitas Kuningan yang mengkhususkan diri dalam pengembangan mobile dan sistem inti AI. Saeful memimpin visi strategis kami dan mendorong inovasi teknis serta kemampuan AI kami.",
      ...
      },
      {
        name: "Dadan Abdillah",
        role: "Founder",
        bio: "Ahli dalam pengembangan web dan arsitektur perangkat lunak. Dadan memastikan platform kami memberikan nilai luar biasa kepada klien kami dan mengelola infrastruktur teknis kami.",
  ...
  privacyPolicyPage: {
    ...
    sections: {
      ...
      informationWeCollect: "2. Informasi yang Kami Kumpulkan",
      useOfYourInformation: "3. Penggunaan Informasi Anda",
      disclosureOfYourInformation: "4. Pengungkapan Informasi Anda",
  ...
  signInPage: {
    title: "Masuk",
    description: "Akses akun One AI Assistant Anda.",
    emailLabel: "Alamat Email",
    emailPlaceholder: "anda@example.com",
  ...
  signUpPage: {
    title: "Buat Akun",
    description: "Bergabunglah dengan One AI Assistant hari ini!",
  ...
  termsOfServicePage: {
    ...
    lastUpdated: "Terakhir Diperbarui: {date}",
    sections: {
      agreementToTerms: "1. Persetujuan terhadap Ketentuan",
      intellectualPropertyRights: "2. Hak Kekayaan Intelektual",
      userRepresentations: "3. Pernyataan Pengguna",
      prohibitedActivities: "4. Aktivitas yang Dilarang",
      serviceAvailability: "5. Ketersediaan dan Modifikasi Layanan",
  ...
  common: {
    ...
    basicRag: "Kapabilitas RAG dasar",
    standardKnowledgeBase: "Integrasi basis pengetahuan standar",
    advancedRag: "Kapabilitas RAG tingkat lanjut",
    multipleKnowledgeBase: "Integrasi beberapa basis pengetahuan",
    priorityEmailSupport: "Dukungan email prioritas",
    basicAnalytics: "Analitik dasar",
    unlimitedInteractions: "Interaksi tanpa batas",
    premiumRagLLM: "Fine-tuning RAG & LLM premium",
