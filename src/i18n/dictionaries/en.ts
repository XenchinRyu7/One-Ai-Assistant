...
export default {
  ...
  pricingPage: {
    ...
    starterPlanDescription:
      "Perfect for small businesses and startups looking to automate basic customer queries.",
    starterFeatures: [
    ...
    professionalPlanDescription:
      "Ideal for growing businesses needing more power and customization.",
  ...
  contactPage: {
    ...
    aiAssistantAvailability:
      "Our AI Assistant is available 24/7 on client websites!",
  ...
  ourTeamsPage: {
    ...
    teamMembers: [
      {
        name: "Dadan Abdillah",
        role: "Founder & CEO",
        bio: "Expert in web development and software architecture. Dadan leads our strategic vision and ensures our platform delivers exceptional value to our clients.",
      ...
      },
      {
        name: "Saeful Rohman",
        role: "Co-Founder & CTO",
        bio: "Computer Science student at Kuningan University specializing in mobile development and AI core systems. Saeful drives our technical innovation and AI capabilities.",
    ...
    finalParagraph:
      "We are a dedicated team of innovators and engineers united by a common goal: to build the most intelligent and helpful AI assistants for businesses worldwide.",
  },
  privacyPolicyPage: {
  ...
  securityDetailsPage: {
    ...
    features: [
      {
        ...
        description:
          "All data, both in transit (using TLS/SSL) and at rest (using AES-256 or stronger), is encrypted to ensure confidentiality and integrity.",
      },
      {
        title: "Access Controls & Authentication",
        description:
          "Robust authentication mechanisms and role-based access controls (RBAC) are implemented to ensure only authorized personnel can access sensitive data and system configurations.",
      },
      {
        title: "Secure Infrastructure",
        description:
          "Our services are hosted on leading cloud providers (e.g., AWS, Google Cloud) that comply with stringent global security standards like ISO 27001, SOC 2, and HIPAA.",
      },
      {
        title: "Regular Security Audits & Penetration Testing",
        description:
          "We conduct regular internal and third-party security audits and penetration tests to identify and remediate potential vulnerabilities.",
      },
      {
        title: "Data Minimization & Retention Policies",
        description:
          "We collect only the data necessary to provide our services and have clear policies for data retention and secure deletion.",
      },
      {
        title: "Incident Response Plan",
        description:
          "A comprehensive incident response plan is in place to promptly address and mitigate any potential security breaches or incidents.",
      },
    ],
    continuousImprovement: {
      ...
      paragraph2:
        "If you have any security-related questions or concerns, please do not hesitate to <1>contact our security team</1>.",
